...
def test_rule_2():
    ...
    assert 'AGS Standard Rule 2' in error_list.keys()
    assert error_list['AGS Standard Rule 2'][0]['line'] == 60
    assert error_list['AGS Standard Rule 2'][0]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 2'][0]['desc'] == 'No DATA rows in group.'
...
def test_rule_2b_1():
    ...
    assert 'AGS Standard Rule 2b' in error_list.keys()
    assert error_list['AGS Standard Rule 2b'][0]['line'] == 7
    assert error_list['AGS Standard Rule 2b'][0]['group'] == 'ABBR'
    assert error_list['AGS Standard Rule 2b'][0]['desc'] == 'UNIT row missing from group.'
...
def test_rule_2b_2():
    ...
    assert error_list['AGS Standard Rule 2b'][1]['line'] == 7
    assert error_list['AGS Standard Rule 2b'][1]['group'] == 'ABBR'
    assert error_list['AGS Standard Rule 2b'][1]['desc'] == 'TYPE row missing from group.'
...
def test_rule_2b_3():
    ...
    assert error_list['AGS Standard Rule 2b'][0]['line'] == 7
    assert error_list['AGS Standard Rule 2b'][0]['group'] == 'ABBR'
    assert error_list['AGS Standard Rule 2b'][0]['desc'] == 'TYPE row missing from group.'
...
def test_rule_2b_4():
    ...
    assert 'AGS Standard Rule 2b' in error_list.keys()
    assert error_list['AGS Standard Rule 2b'][0]['line'] == 10
    assert error_list['AGS Standard Rule 2b'][0]['group'] == 'ABBR'
    assert error_list['AGS Standard Rule 2b'][0]['desc'] == 'UNIT row is misplaced. It should be immediately below the HEADING row.'

    assert error_list['AGS Standard Rule 2b'][1]['line'] == 9
    assert error_list['AGS Standard Rule 2b'][1]['group'] == 'ABBR'
    assert error_list['AGS Standard Rule 2b'][1]['desc'] == 'TYPE row is misplaced. It should be immediately below the UNIT row.'


def test_rule_2c():
    error_list = AGS4.check_file('tests/test_files/DuplicateHeaders.ags')

    assert 'AGS Standard Rule 2c' in error_list.keys()
    assert error_list['AGS Standard Rule 2c'][0]['line'] == 81
    assert error_list['AGS Standard Rule 2c'][0]['desc'] == 'HEADER row has duplicate fields.'
...
def test_rule_3():
    ...
    assert 'AGS Standard Rule 3' in error_list.keys()
    assert error_list['AGS Standard Rule 3'][0]['line'] == 58
    assert error_list['AGS Standard Rule 3'][0]['desc'] == 'Does not start with a valid data descriptor.'
...
def test_rule_7():
    ...
    assert error_list['AGS Standard Rule 7'][0]['line'] == 2
    assert error_list['AGS Standard Rule 7'][0]['group'] == 'PROJ'
    assert error_list['AGS Standard Rule 7'][0]['desc'] == 'Headings not in order starting from FILE_FSET. Expected order: ...PROJ_MEMO|FILE_FSET'
...
def test_rule_8_1():
    ...
    assert 'AGS Standard Rule 8' in error_list.keys()
    assert error_list['AGS Standard Rule 8'][0]['line'] == 76
    assert error_list['AGS Standard Rule 8'][0]['group'] == 'LOCA'
    assert error_list['AGS Standard Rule 8'][0]['desc'] == 'Value 523145.010 in LOCA_NATE not of data type 2DP.'

    assert error_list['AGS Standard Rule 8'][1]['line'] == 77
    assert error_list['AGS Standard Rule 8'][1]['group'] == 'LOCA'
    assert error_list['AGS Standard Rule 8'][1]['desc'] == 'Value 523145.0 in LOCA_NATE not of data type 2DP.'
...
def test_rule_8_2():
    ...
    assert 'AGS Standard Rule 8' in error_list.keys()
    assert error_list['AGS Standard Rule 8'][0]['line'] == 82
    assert error_list['AGS Standard Rule 8'][0]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 8'][0]['desc'] == 'Value 2.455e1 in SAMP_TOP not of data type 2SCI.'

    assert error_list['AGS Standard Rule 8'][1]['line'] == 83
    assert error_list['AGS Standard Rule 8'][1]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 8'][1]['desc'] == 'Value 30.45e1 in SAMP_TOP not of data type 2SCI.'

    assert error_list['AGS Standard Rule 8'][2]['line'] == 84
    assert error_list['AGS Standard Rule 8'][2]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 8'][2]['desc'] == 'Value 3.4e1 in SAMP_TOP not of data type 2SCI.'
...
def test_rule_8_3():
    ...
    assert 'AGS Standard Rule 8' in error_list.keys()
    assert error_list['AGS Standard Rule 8'][0]['line'] == 70
    assert error_list['AGS Standard Rule 8'][0]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 8'][0]['desc'] == 'Value 45.0 in LLPL_LL not of data type 2SF. (Expected: 45)'

    assert error_list['AGS Standard Rule 8'][1]['line'] == 71
    assert error_list['AGS Standard Rule 8'][1]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 8'][1]['desc'] == 'Value 101 in LLPL_LL not of data type 2SF. (Expected: 100)'

    assert error_list['AGS Standard Rule 8'][2]['line'] == 73
    assert error_list['AGS Standard Rule 8'][2]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 8'][2]['desc'] == 'Value 0.2 in LLPL_PI not of data type 2SF. (Expected: 0.20)'
...
def test_rule_8_4():
    ...
    assert 'AGS Standard Rule 8' in error_list.keys()
    assert error_list['AGS Standard Rule 8'][1]['line'] == 79
    assert error_list['AGS Standard Rule 8'][1]['group'] == 'LOCA'
    assert error_list['AGS Standard Rule 8'][1]['desc'] == 'Value 01-12-2020 in LOCA_START not in the ISO date/time format or is an invalid date/time.'

    assert error_list['AGS Standard Rule 8'][2]['line'] == 80
    assert error_list['AGS Standard Rule 8'][2]['group'] == 'LOCA'
    assert error_list['AGS Standard Rule 8'][2]['desc'] == 'Value 2021-02-29 in LOCA_START not in the ISO date/time format or is an invalid date/time.'
...
def test_rule_8_5():
    ...
    assert error_list['AGS Standard Rule 8'][0]['line'] == 76
    assert error_list['AGS Standard Rule 8'][0]['group'] == 'LOCA'
    assert error_list['AGS Standard Rule 8'][0]['desc'] == 'Value 51:68:52.498 in LOCA_LAT not of data type DMS or is an invalid value.'

    assert error_list['AGS Standard Rule 8'][1]['line'] == 77
    assert error_list['AGS Standard Rule 8'][1]['group'] == 'LOCA'
    assert error_list['AGS Standard Rule 8'][1]['desc'] == 'Value 51:28:152.498 in LOCA_LAT not of data type DMS or is an invalid value.'

    assert error_list['AGS Standard Rule 8'][2]['line'] == 78
    assert error_list['AGS Standard Rule 8'][2]['group'] == 'LOCA'
    assert error_list['AGS Standard Rule 8'][2]['desc'] == 'Value :28:152.498 in LOCA_LAT not of data type DMS or is an invalid value.'
...
def test_rule_8_6():
    ...
    assert 'AGS Standard Rule 8' in error_list.keys()
    assert error_list['AGS Standard Rule 8'][3]['line'] == 85
    assert error_list['AGS Standard Rule 8'][3]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 8'][3]['desc'] == 'Value x in SAMP_RECL not of data type U. Numeric value expected.'
...
def test_rule_8_7():
    ...
    assert 'AGS Standard Rule 8' in error_list.keys()
    assert error_list['AGS Standard Rule 8'][4]['line'] == 88
    assert error_list['AGS Standard Rule 8'][4]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 8'][4]['desc'] == 'Value xyz in SAMP_XXXX not of data type YN.'

    assert error_list['AGS Standard Rule 8'][5]['line'] == 89
    assert error_list['AGS Standard Rule 8'][5]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 8'][5]['desc'] == 'Value 10 in SAMP_XXXX not of data type YN.'
...
#    # TODO assert error_list['AGS Standard Rule 7'][0]['line'] == ?
#    assert error_list['AGS Standard Rule 7'][0]['group'] == 'PROJ'
#    assert error_list['AGS Standard Rule 7'][0]['desc'] == 'Headings not in order starting from FILE_FSET. Expected order: ...PROJ_MEMO|FILE_FSET'
...
def test_rule_9_2():
    ...
    assert 'AGS Standard Rule 9' in error_list.keys()
    assert error_list['AGS Standard Rule 9'][0]['line'] == 78
    assert error_list['AGS Standard Rule 9'][0]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 9'][0]['desc'] == 'SAMP_XXXX not found in DICT table or the standard AGS4 dictionary.'
...
def test_rule_10_1():
    ...
    assert 'AGS Standard Rule 10a' in error_list.keys()
    assert error_list['AGS Standard Rule 10a'][0]['line'] == 73
    assert error_list['AGS Standard Rule 10a'][1]['line'] == 74
    assert error_list['AGS Standard Rule 10a'][0]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 10a'][0]['desc'] == 'Duplicate key field combination: DATA|327-16A|15.00|15|U||1|15.00'
...
def test_rule_10_2():
    ...
    assert 'AGS Standard Rule 10a' in error_list.keys()
    # TODO assert error_list['AGS Standard Rule 10a'][0]['line'] == ?
    assert error_list['AGS Standard Rule 10a'][0]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 10a'][0]['desc'] == 'Key field SAMP_ID not found.'
...
def test_rule_10_3():
    ...
    assert 'AGS Standard Rule 10c' in error_list.keys()
    # TODO assert error_list['AGS Standard Rule 10c'][0]['line'] == ?
    assert error_list['AGS Standard Rule 10c'][0]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 10c'][0]['desc'] == 'Parent entry for line not found in SAMP: 327-16A|15.00|15||'
...
def test_rule_10_4():
    ...
    # TODO assert error_list['AGS Standard Rule 10c'][0]['line'] == ?
    assert error_list['AGS Standard Rule 10c'][0]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 10c'][0]['desc'] == 'Parent entry for line not found in SAMP: 327-16A|15.00|15|U|'
...
def test_rule_10_5():
    ...
    assert 'AGS Standard Rule 10c' in error_list.keys()
    # TODO assert error_list['AGS Standard Rule 10c'][0]['line'] == ?
    assert error_list['AGS Standard Rule 10c'][0]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 10c'][0]['desc'] == 'Could not find parent group LOCA.'
...
def test_rule_10_6():
    ...
    assert 'AGS Standard Rule 10b' in error_list.keys()
    assert error_list['AGS Standard Rule 10b'][0]['line'] == 15
    assert error_list['AGS Standard Rule 10b'][0]['group'] == 'ABBR'
    assert error_list['AGS Standard Rule 10b'][0]['desc'] == 'Required field ABBR_DESC not found.'
...
def test_rule_11_1():
    ...
    assert 'AGS Standard Rule 11c' in error_list.keys()
    # TODO assert error_list['AGS Standard Rule 11c'][0]['line'] == ?
    assert error_list['AGS Standard Rule 11c'][0]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 11c'][0]['desc'] == 'Invalid record link: "ISPT|327-16A|2". No such record found.'
...
def test_rule_11_2():
    ...
    # TODO assert error_list['AGS Standard Rule 11c'][0]['line'] == ?
    assert error_list['AGS Standard Rule 11c'][0]['group'] == 'SAMP'
    assert error_list['AGS Standard Rule 11c'][0]['desc'] == 'Invalid record link: "ISPT|327-16A|2.50". "@" should be used as delimiter.'
...
def test_rule_11_3():
    ...
    assert 'AGS Standard Rule 11c' not in error_list.keys()
...
def test_rule_12():
    ...
    assert 'AGS Standard Rule 10b' in error_list.keys()
    # TODO assert error_list['AGS Standard Rule 10b'][0]['line'] == ?
    assert error_list['AGS Standard Rule 10b'][0]['group'] == 'TRAN'
    assert error_list['AGS Standard Rule 10b'][0]['desc'].startswith('Empty REQUIRED fields:')
...
def test_rule_18_OK():
    ...
    assert 'AGS Standard Rule 18' not in error_list.keys()
...
def test_rule_19b_1():
    ...
    assert 'AGS Standard Rule 19b' in error_list.keys()
    assert error_list['AGS Standard Rule 19b'][0]['group'] == 'DEMO'
...
def test_rule_19b_2():
    ...
    assert 'AGS Standard Rule 19b' in error_list.keys()
    assert error_list['AGS Standard Rule 19b'][2]['group'] == 'LLPL'
    assert error_list['AGS Standard Rule 19b'][2]['desc'] == 'XXXX_425 does not start with the name of this group, nor is it defined in another group.'
...
def test_rule_20_OK():
    ...
    assert 'AGS Standard Rule 20' not in error_list.keys()


def test_rule_LBSGCheck():
    error_list = AGS4.check_file('tests/test_files/LBSGCheck.ags')

    assert 'AGS Standard Rule 10c' not in error_list.keys()
